...
SET @sql = IF((SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'employee_family_members') > 0, 'ALTER TABLE employee_family_members MODIFY COLUMN relationship_type VARCHAR(100) NULL, MODIFY COLUMN extension_name VARCHAR(50) NULL, MODIFY COLUMN first_name VARCHAR(100) NULL, MODIFY COLUMN middle_name VARCHAR(100) NULL, MODIFY COLUMN last_name VARCHAR(100) NULL, MODIFY COLUMN date_of_birth DATE NULL, MODIFY COLUMN telephone_number VARCHAR(50) NULL, MODIFY COLUMN business_address TEXT NULL, MODIFY COLUMN occupation VARCHAR(150) NULL, MODIFY COLUMN employer_name VARCHAR(150) NULL, MODIFY COLUMN deceased BOOLEAN NULL', 'SELECT 1');
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF((SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'employee_work_experiences') > 0, 'ALTER TABLE employee_work_experiences MODIFY COLUMN company_name VARCHAR(255) NULL, MODIFY COLUMN position_title VARCHAR(150) NULL, MODIFY COLUMN employment_type VARCHAR(100) NULL, MODIFY COLUMN date_from DATE NULL, MODIFY COLUMN date_to DATE NULL, MODIFY COLUMN supervisor_name VARCHAR(150) NULL, MODIFY COLUMN company_address TEXT NULL, MODIFY COLUMN reason_for_leaving TEXT NULL', 'SELECT 1');
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = IF((SELECT COUNT(*) FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'employee_trainings') > 0, 'ALTER TABLE employee_trainings MODIFY COLUMN training_name VARCHAR(255) NULL, MODIFY COLUMN provider VARCHAR(255) NULL, MODIFY COLUMN date_from DATE NULL, MODIFY COLUMN date_to DATE NULL, MODIFY COLUMN training_hours DECIMAL(10,2) NULL, MODIFY COLUMN remarks TEXT NULL', 'SELECT 1');
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
