...
exports.up = function(db) {
  return runSqlFile(db, '20260617120000-permissioned-blockchain-payroll-up.sql');
};

exports.down = function(db) {
  return runSqlFile(db, '20260617120000-permissioned-blockchain-payroll-down.sql');
};
