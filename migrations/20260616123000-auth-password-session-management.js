...
exports.up = function(db) {
  return runSqlFile(db, '20260616123000-auth-password-session-management-up.sql');
};

exports.down = function(db) {
  return runSqlFile(db, '20260616123000-auth-password-session-management-down.sql');
};
