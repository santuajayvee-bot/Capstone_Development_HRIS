...
exports.up = db => runSqlFile(db, '20260622190000_add_mocean_mfa_challenges-up.sql');
exports.down = db => runSqlFile(db, '20260622190000_add_mocean_mfa_challenges-down.sql');
