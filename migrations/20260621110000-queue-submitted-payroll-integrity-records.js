...
exports.up = function(db) {
  return runSqlFile(db, '20260621110000_queue_submitted_payroll_integrity_records-up.sql');
};

exports.down = function(db) {
  return runSqlFile(db, '20260621110000_queue_submitted_payroll_integrity_records-down.sql');
};
