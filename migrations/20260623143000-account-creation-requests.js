...
exports.up = db => runSqlFile(db, '20260623143000_account_creation_requests-up.sql');
exports.down = db => runSqlFile(db, '20260623143000_account_creation_requests-down.sql');
