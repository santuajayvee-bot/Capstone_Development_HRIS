...
exports.up = db => runSqlFile(db, '20260622170000_partial_offboarding_support-up.sql');
exports.down = db => runSqlFile(db, '20260622170000_partial_offboarding_support-down.sql');
